...
# emotion_coordinates = [(-10, 10), (-8, -10), (-3, -2),
#                        (5, 3), (8, 8), (10, 10),
#                        (-8, 7), (10, 6), (0, 1),
#                        (6, 3), (-10, -10), (3, 8), (-6, 7)]  original

# def get_all_emotions(predictions):
#
#     emotion_list = []
#
#     for i in range(len(emotion)):
#         emotion_list.append(emotion[i] + " : " + str(round(predictions[0][i], 5)))
#
#     return emotion_list
...
# ax.plot(x, y, 'bo')
#
# x2 = int(input("Your target x: "))
# y2 = int(input("Your target y:"))
#
# ax.plot(x2, y2, 'ro')
#
# ax.set_xlabel('X-axis')
# ax.set_ylabel('Y-axis')
# ax.set_title('initial emotion')
#
# plt.show()
